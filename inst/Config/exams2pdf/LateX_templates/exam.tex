...
%% headings
\markboth{\textnormal{\bf \large \mySubtitle: \myID}}%
{\textnormal{\bf \large \mySubtitle: \myID}}
...
\textbf{\large{ \mySubtitle: \myDate \hfill Exam ID \myID}}

\vspace*{2cm}

\begin{tabular}{p{14cm}}
\textbf{Nom:} \hrule \\[1.5cm]
\textbf{Matricule:} \hrule \\[1.5cm]
